...
const product = {"repo":"DayForge","suite":"AI Productivity Suite","category":"Daily execution","audience":"busy founders, builders, and high-agency teams","promise":"turn a chaotic day into a sharp execution plan with recovery buffers","inputLabel":"Today's goals, meetings, and constraints","placeholder":"3 calls, launch landing update, gym at 6, need deep work for proposal","primary":"Forge my day","gradient":"from-amber-200 via-orange-300 to-rose-300","metrics":["Priority stack","Energy-aware","Recovery buffer"],"modules":["Priority sorting","Calendar blocks","Focus sprints","Risk flags","End-of-day review"],"outputs":["Daily command plan","Protected deep work","Delay recovery path","Shutdown checklist"],"pricing":"Free daily plan, $15/month Personal, $79/month Team rituals."} as const;
